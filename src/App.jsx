...
const App = () => {
  ...
  // ***TODO***
    dispatch(deposit({amount:Number(withdrawalAmount)}));// Dispatch withdrawal action with the entered withdrawal amount
  ...
  const handleTransfer = () => {
     ...
     dispatch(transfer({
      name:transferName,
      amount:Number(transferAmount)}))// Dispatch transfer action with the entered recipient name and transfer amount
